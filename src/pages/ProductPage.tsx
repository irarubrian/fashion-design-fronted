      ...
      <div className="container mx-auto px-4">
        ...
        <nav className="mb-8">
          <ol className="flex text-sm text-gray-500">
            ...
            <li>
              <Link to={`/category/${product.category}`} className="hover:text-burgundy-600 capitalize">{product.category}</Link>
              <span className="mx-2">/</span>
            </li>
            ...
            <div className="mb-6">
              {product.originalPrice ? (
                <div className="flex items-center">
                  <p className="text-2xl font-bold text-burgundy-600">${product.price.toFixed(2)}</p>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="flex items-center mb-2">
                      <p className="text-sm text-gray-500">Sarah J. - <span>Verified Buyer</span></p>
                      <p className="text-sm text-gray-500 ml-4">March 15, 2025</p>
                    </div>
                    <p className="text-gray-600">
                      I love this piece! The material feels luxurious and the fit is perfect. Definitely worth the investment.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="flex items-center mb-2">
                      <p className="text-sm text-gray-500">Michael T. - <span>Verified Buyer</span></p>
                  ...
                  <button className="text-burgundy-600 font-medium hover:text-burgundy-800">
                    Load More Reviews
                  </button>
                </div>
              </div>
