    ...
    <div className="min-h-screen py-32">
      <div className="container mx-auto px-4">
        <div className="flex items-center mb-8">
          <Heart size={24} className="text-burgundy-600 mr-2" />
        ...
        {wishlist.items.length === 0 ? (
          <div className="text-center py-12 max-w-md mx-auto">
            ...
            <Link 
              to="/"
              className="inline-block px-6 py-3 bg-burgundy-600 text-white rounded-md hover:bg-burgundy-700 transition-colors"
            >
              Continue Shopping
            </Link>
          </div>
                  ...
                  <tr key={item.id}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <Link to={`/product/${item.id}`} className="text-gray-900 font-medium hover:text-burgundy-600">
                            {item.name}
                          </Link>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {item.originalPrice ? (
                        <div>
                          <p className="text-burgundy-600 font-medium">${item.price.toFixed(2)}</p>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex justify-end space-x-2">
                        <button
                          ...
                          className="p-2 rounded-full text-gray-400 hover:text-burgundy-600 hover:bg-burgundy-50 transition-colors"
